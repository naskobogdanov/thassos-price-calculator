...
$(document).ready(function () {
    $('#en').click(function () {
        ...
        $('#Consumption').attr("placeholder", "Fuel consumption per 100km");
    ...
    $('#bg').click(function () {
        $('#headerTitle').text("Tасос Цалц");
        $('#required').text("Задължително Поле");
        $('#Passengers').attr("placeholder", "Въведете брой пътници");
        $('#Consumption').attr("placeholder", "Раазход на гориво за 100 км");
        ...
        $('#approximatePrice').text("Това е приблизително изчислена цена, която включва пътните разхофи и три нощувки на къмпинг Пефкари.");
